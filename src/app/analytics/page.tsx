...
export default function AnalyticsPage() {
  ...
  const { comparisons, averages, isLoading: isLoadingComparisons } = useMinerComparison(selectedMiners);
    ...
    return (
      <div className="container mx-auto px-4 py-16 min-h-screen">
        <Card className="p-12 text-center max-w-2xl mx-auto">
          ...
          <h2 className="text-2xl font-bold text-white mb-2">No tienes CoreMiners</h2>
          <p className="text-gray-400 mb-6">
            Necesitas tener al menos un CoreMiner para usar las herramientas de análisis
          </p>
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="flex items-center justify-between flex-wrap gap-4">
          <div>
            ...
            <p className="text-gray-400">Análisis comparativo y rendimiento de CoreMiners</p>
          </div>
        ...
        <div className="flex items-center justify-between mb-4">
          <h2 className="text-xl font-bold text-white">Selecciona Miners para Comparar</h2>
          <Badge variant="default">
            {selectedMiners.length}/5 seleccionados
          </Badge>
        </div>
        <p className="text-sm text-gray-400 mb-4">
          Selecciona hasta 5 miners para comparar su rendimiento (click para agregar/quitar)
        </p>
        
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-3">
          {miners.map((miner) => {
            const isSelected = selectedMiners.some(id => id.toString() === miner.tokenId.toString());
          ...
          <div className="mt-4 p-4 bg-yellow-500/10 border border-yellow-500/30 rounded-lg">
            <div className="flex items-center gap-2 text-yellow-400">
              ...
              <span className="text-sm">
                Selecciona al menos un miner para ver estadísticas comparativas
              </span>
            </div>
          </div>
        )}
          ...
          <>
            {isLoadingComparisons ? (
              ...
              <>
                ...
                {averages && (
                  <Card variant="glass" className="p-6 mb-6">
                  <h2 className="text-xl font-bold text-white mb-4">📈 Promedios de Selección</h2>
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    <div className="text-center p-4 bg-gray-800 rounded-lg">
                      <div className="text-2xl font-bold text-white mb-1">
                        {averages.avgDurability.toFixed(1)}%
                      </div>
                      <div className="text-sm text-gray-400">Durabilidad Promedio</div>
                    </div>
                    <div className="text-center p-4 bg-gray-800 rounded-lg">
                      <div className="text-2xl font-bold text-white mb-1">
                        {averages.avgEfficiency.toFixed(1)}%
                      </div>
                      <div className="text-sm text-gray-400">Eficiencia Promedio</div>
                    </div>
                    <div className="text-center p-4 bg-gray-800 rounded-lg">
                      <div className="text-2xl font-bold text-white mb-1">
                    ...
                    <div className="text-center p-4 bg-gray-800 rounded-lg">
                      ...
                      <div className="text-sm text-gray-400">Multiplicador Promedio</div>
                    </div>
                  </div>
                  </Card>
                )}
                ...
                <h2 className="text-xl font-bold text-white mb-4">📋 Tabla Comparativa Detallada</h2>
        ...
        <h2 className="text-xl font-bold text-white mb-4">💡 Tips de Análisis</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-sm">
          <div>
            ...
            <ul className="space-y-2 text-gray-300">
              <li>• <strong>Durabilidad:</strong> Salud actual del miner (0-100%)</li>
              <li>• <strong>Eficiencia:</strong> Rendimiento de minería (afectado por durabilidad)</li>
              <li>• <strong>Total Rewards:</strong> fCORE acumulado histórico</li>
              <li>• <strong>Ciclos Completados:</strong> Total de ciclos de minería finalizados</li>
            </ul>
          </div>
          <div>
            <h3 className="font-bold text-white mb-2 flex items-center gap-2">
            ...
            <ul className="space-y-2 text-gray-300">
              ...
              <li>• Compara rarities para entender diferencias de rendimiento</li>
        ...
        <div className="mt-6 grid grid-cols-1 md:grid-cols-3 gap-4">
          <Link href="/staking">
            <Card variant="glass" className="p-6 hover:border-green-500/50 transition-colors cursor-pointer">
            <div className="text-4xl mb-3">⛏️</div>
            <h3 className="text-lg font-bold text-white mb-2">Mining Dashboard</h3>
          ...
          <Link href="/collection">
            <Card variant="glass" className="p-6 hover:border-orange-500/50 transition-colors cursor-pointer">
