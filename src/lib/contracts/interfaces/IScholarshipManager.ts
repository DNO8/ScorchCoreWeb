...
export interface IScholarshipManager extends Contract {
  // ============================================
   ...
   */
  acceptOffer(minerId: bigint): Promise<ContractTransaction>;
  
  /**
   * Cancela una oferta (solo owner)
   * @param minerId - ID del CoreMiner
   */
  cancelOffer(minerId: bigint): Promise<ContractTransaction>;
  
  /**
   * Finaliza un préstamo activo (owner o scholar)
   * @param minerId - ID del CoreMiner
   */
  endLoan(minerId: bigint): Promise<ContractTransaction>;
   ...
   */
  splitRewards(minerId: bigint, totalRewards: bigint): Promise<ContractTransaction>;
   ...
   */
  calculateSplit(minerId: bigint, totalRewards: bigint): Promise<{
    ownerAmount: bigint;
   ...
   */
  setShareLimits(minOwnerShare: number, maxScholarShare: number): Promise<ContractTransaction>;
